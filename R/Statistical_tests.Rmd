...
for (i in 1:k) {
  ...
  pt18_sliced$weight <- sample(c(0,1),size=nrow(pt18_sliced),replace=TRUE,prob=c(0.2,0.8)) #0 Indicates testing sample, 1 training sample
  
  #Generate training dataset
  trainingdata <- pt18_sliced[pt18_sliced$weight == 1, ] #Select test data by weight  

  #Generate test dataset
  testdata <- pt18_sliced[pt18_sliced$weight == 0, ] #Select test data by weight
  ...
  #Extract MSES
  mses[i,1] <- mean((pt18_sliced$open_chest_cvp[pt18_sliced$weight==0] - pred)^2)
