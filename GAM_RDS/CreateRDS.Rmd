...
```{r}
rm(list = ls())
filepath <- "../Datasets/thoracotomy_waveforms/pt11.RDS"
...
```{r}
pt <- create_patient_open(filepath)
...
```{r slicing data}
pt_sliced <- all_in_one_patient(filepath=filepath, period="open", slice_start=154,slice_end=200)
