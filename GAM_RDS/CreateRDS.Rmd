...
```{r}
rm(list = ls())
filepath <- "../Datasets/thoracotomy_waveforms/pt61.RDS"
...
```{r slicing data}
pt_sliced <- all_in_one_patient(filepath=filepath, period="open", slice_start=0,slice_end=173)
